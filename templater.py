...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self' ; script-src 'self' 'unsafe-inline' wow.zamimg.com; style-src 'self' 'unsafe-inline' wow.zamimg.com cdn.rawgit.com; img-src 'self' *; media-src 'self' ; frame-src wow.zamimg.com;">
